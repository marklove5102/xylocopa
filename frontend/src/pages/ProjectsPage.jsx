...
const FolderCard = memo(function FolderCard({ folder, onClick, onActivate, onArchive, busy, dragHandleProps, hasPendingClaudeMd }) {
  ...
  return (
    <button
      ...
      className="relative w-full text-left rounded-xl bg-surface shadow-card overflow-hidden transition-colors active:bg-input focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 hover:ring-1 hover:ring-ring-hover"
    >
      {hasPendingClaudeMd && (
