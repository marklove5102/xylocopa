  ...
  if (hasUnread) {
    ...
    return (
      <DraggableFab
        ...
        className="w-11 h-11 flex items-center justify-center rounded-full bg-blue-500 hover:bg-blue-400 shadow-lg shadow-blue-500/30 text-white font-semibold text-sm transition-colors"
      >
        {label}
      </DraggableFab>
    );
