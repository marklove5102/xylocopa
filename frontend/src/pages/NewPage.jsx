...
export default function NewPage({ theme, onToggleTheme }) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* Back header */}
      <div className="shrink-0 bg-page border-b border-divider px-4 pt-4 pb-2 relative z-10 safe-area-pt">
        <button type="button" onClick={goBack} className="flex items-center gap-1 min-h-[44px] text-sm text-label hover:text-heading active:text-heading">
