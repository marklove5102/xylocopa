...
class WorkerManager:
    ...
    def _build_prompt(self, task: Task, project: Project) -> str:
        ...
        return (
            ...
            f"- NEVER modify files outside the project directory or run destructive DB operations\n"
            f"- If you need to reset a branch, use a worktree — do NOT touch the main working tree\n"
            f"\n"
            f"Task:\n{task.prompt}\n"
            f"\n"
            f"When done:\n"
